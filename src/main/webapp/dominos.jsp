...
<nav class="sidebar">
    <div class="text">
    <a href="./dominos.jsp"><i class="fa fa-home"></i></a>
    <ul>
...
<section class="home" id="home">
    <div class="barb">
    <h2><img src="./Images/Restaurants/dominos_social_logo.jpg" height="350"></h2>
...
<section class="veg" id="pizza">
    ...
    <div class="box">
        ...
        <span>₹339</span>
        <br>
        <a href="saveToCart.jsp?product=Double_cheese_marghherita&quantity=1&price=339" class="btn">Add to cart</a>
    </div>
    <div class="box">

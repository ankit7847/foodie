...
<head>
    ...
    <title>Hot n Spicy | Restaurant</title>
...
<section class="home" id="home">
    <div class="barb">
    <h2><img src="./Images/Restaurants/hotnspicy.jpg" height="350"></h2>
    
        </div>
</section>

<section class="meh" id="biryani">
    <h2 class="hitech">Hot n Spicy</h2>
    <hr class="line">
    <h4>Biryani's</h4>  
...
<section class="soups" id="soup">
    <h2 class="hotnspicy">Hot n Spicy</h2>
    <hr class="line">
    <h4>Soup</h4> 
    <div class="box-soup">
        <div class="box">
...
<section class="fastfood" id="fast">
    <h2 class="fastfood1">Hot n Spicy</h2>
    <hr class="line">
    <h4>Fast Food</h4>

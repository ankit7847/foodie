...
<link rel="stylesheet" href="./dosaplaza.css">
...
<nav class="sidebar">
    <div class="text">
    <a href="./ramkibandi.jsp"><i class="fa fa-home"></i></a>
    <ul>
...
<section class="home" id="home">
    <div class="barb">
    <h2><img src="./Images/Restaurants/platform65.jpg" height="350"></h2>
    
        </div>
</section>
<section class="breakfast" id="fast">
    <h2 class="breakfast1">Ram Ki Bandi</h2>
    <hr class="line">
    <h4>Break Fast</h4>

...
<head>
    ...
    <header>
        ...
        <a href="#" class="logo"><i class="fa fa-utensils"></i><img src="./Images/Background/logo.png"></a>
        <nav class="navbar">
    ...
    <section class="home" id="home-section">
        ...
        <div class="add">
            <div class="add-container">
                ...
                <div class="textimg">
                    <h2>Discover Resturants &<br>Delicious Food</h2>
                    <a href="./login.jsp"><button class="ordr">Order Now</button></a>
                </div>
        ...
        <div class="table">
            <a href="./dishes.jsp"><img src="./Images/Dishes/Chicken-Biryani.jpg" height="150">
                <h4>Biryani</h4>
            </a>
            <a href="./dishes.jsp"><img src="./Images/Dishes/chicken.jpeg" height="150">
                <h4>Chicken Lolipop</h4>
            </a>
            <a href="./dishes.jsp"><img src="./Images/Dishes/panner tikka.jpg" height="150">
                <h4>Panner Tikka</h4>
            </a>
            <a href="./dishes.jsp"><img src="./Images/Dishes/garlicprawns.jpg" height="150">
                <h4>Garlic Prawns</h4>
            </a>
            <a href="./dishes.jsp"><img src="./Images/Dishes/vegpulao.jpg" height="150">
                <h4>Veg Pulao</h4>
            </a>
        ...
        <div class="table1">
            <a href="./Barbeque.jsp"><img src="./Images/Restaurants/barbeque.jpg" height="150">
                <h4>Barbeque</h4>
                <p>tandoori, biryani, Starters</p>
            </a>
            <a href="./paradise.jsp"><img src="./Images/Restaurants/paradise.jpg" height="150">
                <h4>Paradise</h4>
                <p>tandoori, biryani, Starters, deserts</p>
            </a>
            <a href="./dominos.jsp"><img src="./Images/Restaurants/dominos.jpg" height="150">
                <h4>Domino's</h4>
                <p>Pizza, Burger</p>
            </a>
            <a href="./dosaplaza.jsp"><img src="./Images/Restaurants/platform65.jpg" height="150">
                <h4>Dosa Plaza</h4>
                <p>Breakfast</p>
            </a>
            <a href="./hotnspicy.jsp"><img src="./Images/Restaurants/hotnspicy.jpg" height="150">
                <h4>Hot & Spicy</h4>
        ...
        <section class="barb" id="biryani">
            ...
            <div class="box-container">
                <div class="box">
                    <a href="./barbeque.jsp"><img src="./Images/Restaurants/barbeque.jpg"></a>
                    <h3>Barbeque</h3>
                    <div class="stars">
                ...
                <div class="box">
                    <a href="./mehfil.jsp"><img src="./Images/Restaurants/mehfil.jpg"></a>
                    <h3>Mehfil</h3>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <div class="box">
                    <a href="./dominos.jsp"><img src="./Images/Restaurants/dominos.jpg"></a>
                    <h3>Domino's</h3>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <div class="box">
                    <a href="./paradise.jsp"><img src="./Images/Restaurants/paradise.jpg"></a>
                    <h3>Paradise</h3>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <div class="box">
                    <a href="./dosaplaza.jsp"><img src="./Images/Restaurants/platform65.jpg"></a>
                    <h3>Dosa Plaza</h3>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <div class="box">
                    <a href="./hotnspicy.jsp"><img src="./Images/Restaurants/hotnspicy.jpg"></a>
                    <h3>Hot N Spicy</h3>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
                ...
                <div class="box">
                    <a href="./mughal.jsp"><img src="./Images/Restaurants/mughal.jpg"></a>
                ...
                <div class="box">
                    <a href="./ksbakers.jsp"><img src="./Images/Restaurants/ksbakers.png"></a>
                    <h3>KS Bakers</h3>
                    <div class="stars">
                        <i class="fas fa-star"></i>
                        <i class="fas fa-star"></i>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="footer-col">
                    <h4>Order Now</h4>
                    <ul>
                        <li><a href="./dishes.jsp">Biryani's</a></li>

...
<body>
    ...
    <header>
        ...
        <div class="icons">
            ...
            <a href="#" id="shopping-list" class="fas fa-shopping-cart"></a>
...
<nav class="sidebar">
    <div class="text">
    <a href="./barbeque.jsp"><i class="fa fa-home"></i></a>
    <ul>
        <li><a href="#biryani">Biryani's</a></li>
        <li><a href="#start">Starter's</a></li>
        <li><a href="#roti">Roti's</a></li>
        <li><a href="#curry">Curry's</a></li>
    </ul>
</div>
</nav>
<!--Side bar ends-->
<section class="home" id="home">
    <div class="barb">
    <h2><img src="./Images/Restaurants/barbeque1.jpg" height="350"></h2>
        </div>
</section>

<section class="barb" id="biryani">
    <h2 class="barbeque">Barbeque</h2>
    <hr class="line">
    <h4>Biryani's</h4>  
...
<section class="currys" id="curry">
    ...
    <div class="box-curry">
        <div class="box">
            ...
            <span>₹250</span>
            <br>
            <a class="btn" id="add-to-list">Add to cart</a>
        </div>
        ...
        <div class="box">
            ...
            <span>₹240</span>
            <br>
            <a href="#" class="btn" id="add-to-list">Add to cart</a>
        </div>
        <div class="box">
